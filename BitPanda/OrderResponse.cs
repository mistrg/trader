...
namespace Trader.BitPanda
{
    ...
    public class OrderResponse
    {
        ...
        public class Trade
        {
            ...
            public Trade2 trade { get; set; }

            public double fee_QuoteAmountNum { get { return fee.fee_amountNum * trade.priceNum; } }
            public double quoteAmountNum { get { return trade.amountNum * trade.priceNum; } }
        }
